...
bool tms_msg_ts__srv__ts_req__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tms_msg_ts.srv._ts_req.TsReq_Request",
        full_classname_dest, 36) == 0);
  }
  tms_msg_ts__srv__TsReq_Request * ros_message = _ros_message;
  {  // rostime
...
{
  /* NOTE(esteve): Call constructor of TsReq_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tms_msg_ts.srv._ts_req");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TsReq_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool tms_msg_ts__srv__ts_req__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tms_msg_ts.srv._ts_req.TsReq_Response",
        full_classname_dest, 37) == 0);
  }
  tms_msg_ts__srv__TsReq_Response * ros_message = _ros_message;
  {  // result
...
{
  /* NOTE(esteve): Call constructor of TsReq_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tms_msg_ts.srv._ts_req");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TsReq_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
