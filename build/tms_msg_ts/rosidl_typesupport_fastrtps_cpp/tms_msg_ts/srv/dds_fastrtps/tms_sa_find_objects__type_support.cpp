...
#include "tms_msg_ts/srv/tms_sa_find_objects__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.search_furnitures_id;
  }
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  // Member: search_furnitures_id
  {
    ...
    size_t item_size = sizeof(ros_message.search_furnitures_id[0]);
...
{
  auto typed_message =
    static_cast<const tms_msg_ts::srv::TmsSaFindObjects_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tms_msg_ts::srv::TmsSaFindObjects_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TmsSaFindObjects_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tms_msg_ts::srv::TmsSaFindObjects_Request *>(
...
{
  return max_serialized_size_TmsSaFindObjects_Request(full_bounded, 0);
}

static message_type_support_callbacks_t _TmsSaFindObjects_Request__callbacks = {
  "tms_msg_ts::srv",
...
static rosidl_message_type_support_t _TmsSaFindObjects_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TmsSaFindObjects_Request__callbacks,
...
{
  return &tms_msg_ts::srv::typesupport_fastrtps_cpp::_TmsSaFindObjects_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  // Member: object_id
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.object_id[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: object_x
  ...
  // Member: object_z
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.object_z[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: furnitures_id
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.furnitures_id[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
{
  auto typed_message =
    static_cast<const tms_msg_ts::srv::TmsSaFindObjects_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<tms_msg_ts::srv::TmsSaFindObjects_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _TmsSaFindObjects_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tms_msg_ts::srv::TmsSaFindObjects_Response *>(
...
{
  return max_serialized_size_TmsSaFindObjects_Response(full_bounded, 0);
}

static message_type_support_callbacks_t _TmsSaFindObjects_Response__callbacks = {
  "tms_msg_ts::srv",
...
static rosidl_message_type_support_t _TmsSaFindObjects_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TmsSaFindObjects_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &tms_msg_ts::srv::typesupport_fastrtps_cpp::_TmsSaFindObjects_Response__handle;
}
...
static service_type_support_callbacks_t _TmsSaFindObjects__callbacks = {
  "tms_msg_ts::srv",
  "TmsSaFindObjects",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tms_msg_ts, srv, TmsSaFindObjects_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tms_msg_ts, srv, TmsSaFindObjects_Response)(),
...
static rosidl_service_type_support_t _TmsSaFindObjects__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_TmsSaFindObjects__callbacks,
...
{
  return &tms_msg_ts::srv::typesupport_fastrtps_cpp::_TmsSaFindObjects__handle;
}
