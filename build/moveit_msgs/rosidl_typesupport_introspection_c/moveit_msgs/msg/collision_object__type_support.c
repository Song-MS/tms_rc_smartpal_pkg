...
static rosidl_typesupport_introspection_c__MessageMember CollisionObject__rosidl_typesupport_introspection_c__CollisionObject_message_member_array[12] = {
  {
    "header",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, msg, CollisionObject)() {
  ...
  CollisionObject__rosidl_typesupport_introspection_c__CollisionObject_message_member_array[8].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Pose)();
  CollisionObject__rosidl_typesupport_introspection_c__CollisionObject_message_member_array[10].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Pose)();
