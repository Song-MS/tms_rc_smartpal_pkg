...
// Member `pre_place_approach`
// Member `post_place_retreat`
#include "moveit_msgs/msg/gripper_translation__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__MessageMember PlaceLocation__rosidl_typesupport_introspection_c__PlaceLocation_message_member_array[6] = {
  {
    "id",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, msg, PlaceLocation)() {
  ...
  PlaceLocation__rosidl_typesupport_introspection_c__PlaceLocation_message_member_array[3].members_ =
