...
static rosidl_typesupport_introspection_c__MessageMember PositionIKRequest__rosidl_typesupport_introspection_c__PositionIKRequest_message_member_array[10] = {
  {
    "group_name",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(moveit_msgs__msg__PositionIKRequest, attempts),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
