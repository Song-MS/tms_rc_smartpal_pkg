...
#include <stddef.h>
#include "moveit_msgs/action/execute_trajectory__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers moveit_msgs__action__execute_trajectory__rosidl_typesupport_introspection_c__ExecuteTrajectory_SendGoal_service_members = {
  "moveit_msgs__action",  // service namespace
  "ExecuteTrajectory_SendGoal",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // moveit_msgs__action__execute_trajectory__rosidl_typesupport_introspection_c__ExecuteTrajectory_SendGoal_Request_message_type_support_handle,
  NULL  // response message
  // moveit_msgs__action__execute_trajectory__rosidl_typesupport_introspection_c__ExecuteTrajectory_SendGoal_Response_message_type_support_handle
};

static rosidl_service_type_support_t moveit_msgs__action__execute_trajectory__rosidl_typesupport_introspection_c__ExecuteTrajectory_SendGoal_service_type_support_handle = {
  0,
  &moveit_msgs__action__execute_trajectory__rosidl_typesupport_introspection_c__ExecuteTrajectory_SendGoal_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, action, ExecuteTrajectory_SendGoal)() {
  if (!moveit_msgs__action__execute_trajectory__rosidl_typesupport_introspection_c__ExecuteTrajectory_SendGoal_service_type_support_handle.typesupport_identifier) {
    moveit_msgs__action__execute_trajectory__rosidl_typesupport_introspection_c__ExecuteTrajectory_SendGoal_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)moveit_msgs__action__execute_trajectory__rosidl_typesupport_introspection_c__ExecuteTrajectory_SendGoal_service_type_support_handle.data;
  ...
  return &moveit_msgs__action__execute_trajectory__rosidl_typesupport_introspection_c__ExecuteTrajectory_SendGoal_service_type_support_handle;
}
...
// this is intentionally not const to allow initialization later to prevent an initialization race
static rosidl_typesupport_introspection_c__ServiceMembers moveit_msgs__action__execute_trajectory__rosidl_typesupport_introspection_c__ExecuteTrajectory_GetResult_service_members = {
  "moveit_msgs__action",  // service namespace
  "ExecuteTrajectory_GetResult",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // moveit_msgs__action__execute_trajectory__rosidl_typesupport_introspection_c__ExecuteTrajectory_GetResult_Request_message_type_support_handle,
  NULL  // response message
  // moveit_msgs__action__execute_trajectory__rosidl_typesupport_introspection_c__ExecuteTrajectory_GetResult_Response_message_type_support_handle
};

static rosidl_service_type_support_t moveit_msgs__action__execute_trajectory__rosidl_typesupport_introspection_c__ExecuteTrajectory_GetResult_service_type_support_handle = {
  0,
  &moveit_msgs__action__execute_trajectory__rosidl_typesupport_introspection_c__ExecuteTrajectory_GetResult_service_members,
  get_service_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, action, ExecuteTrajectory_GetResult)() {
  if (!moveit_msgs__action__execute_trajectory__rosidl_typesupport_introspection_c__ExecuteTrajectory_GetResult_service_type_support_handle.typesupport_identifier) {
    moveit_msgs__action__execute_trajectory__rosidl_typesupport_introspection_c__ExecuteTrajectory_GetResult_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)moveit_msgs__action__execute_trajectory__rosidl_typesupport_introspection_c__ExecuteTrajectory_GetResult_service_type_support_handle.data;
  ...
  return &moveit_msgs__action__execute_trajectory__rosidl_typesupport_introspection_c__ExecuteTrajectory_GetResult_service_type_support_handle;
}
