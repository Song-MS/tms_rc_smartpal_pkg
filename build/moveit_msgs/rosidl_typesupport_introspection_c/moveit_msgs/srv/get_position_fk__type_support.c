...
#include <stddef.h>
#include "moveit_msgs/srv/get_position_fk__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers moveit_msgs__srv__get_position_fk__rosidl_typesupport_introspection_c__GetPositionFK_service_members = {
  "moveit_msgs__srv",  // service namespace
  "GetPositionFK",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // moveit_msgs__srv__get_position_fk__rosidl_typesupport_introspection_c__GetPositionFK_Request_message_type_support_handle,
  NULL  // response message
  // moveit_msgs__srv__get_position_fk__rosidl_typesupport_introspection_c__GetPositionFK_Response_message_type_support_handle
};

static rosidl_service_type_support_t moveit_msgs__srv__get_position_fk__rosidl_typesupport_introspection_c__GetPositionFK_service_type_support_handle = {
  0,
  &moveit_msgs__srv__get_position_fk__rosidl_typesupport_introspection_c__GetPositionFK_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, srv, GetPositionFK)() {
  if (!moveit_msgs__srv__get_position_fk__rosidl_typesupport_introspection_c__GetPositionFK_service_type_support_handle.typesupport_identifier) {
    moveit_msgs__srv__get_position_fk__rosidl_typesupport_introspection_c__GetPositionFK_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)moveit_msgs__srv__get_position_fk__rosidl_typesupport_introspection_c__GetPositionFK_service_type_support_handle.data;
  ...
  return &moveit_msgs__srv__get_position_fk__rosidl_typesupport_introspection_c__GetPositionFK_service_type_support_handle;
}
