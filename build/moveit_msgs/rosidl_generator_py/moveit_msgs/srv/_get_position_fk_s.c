...
bool moveit_msgs__srv__get_position_fk__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.srv._get_position_fk.GetPositionFK_Request",
  ...
  {  // fk_link_names
    ...
    rosidl_generator_c__String * dest = ros_message->fk_link_names.data;
...
PyObject * moveit_msgs__srv__get_position_fk__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // fk_link_names
    ...
    rosidl_generator_c__String * src = ros_message->fk_link_names.data;
...
bool moveit_msgs__srv__get_position_fk__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.srv._get_position_fk.GetPositionFK_Response",
