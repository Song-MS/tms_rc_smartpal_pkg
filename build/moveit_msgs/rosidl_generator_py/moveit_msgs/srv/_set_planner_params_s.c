...
bool moveit_msgs__srv__set_planner_params__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.srv._set_planner_params.SetPlannerParams_Request",
  ...
  {  // planner_config
    ...
    rosidl_generator_c__String__assign(&ros_message->planner_config, PyBytes_AS_STRING(encoded_field));
  ...
  {  // group
    ...
    rosidl_generator_c__String__assign(&ros_message->group, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // params
...
bool moveit_msgs__srv__set_planner_params__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.srv._set_planner_params.SetPlannerParams_Response",
