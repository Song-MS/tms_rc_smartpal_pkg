...
bool moveit_msgs__srv__list_robot_states_in_warehouse__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.srv._list_robot_states_in_warehouse.ListRobotStatesInWarehouse_Request",
  ...
  {  // regex
    ...
    rosidl_generator_c__String__assign(&ros_message->regex, PyBytes_AS_STRING(encoded_field));
...
bool moveit_msgs__srv__list_robot_states_in_warehouse__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.srv._list_robot_states_in_warehouse.ListRobotStatesInWarehouse_Response",
  ...
  {  // states
    ...
    rosidl_generator_c__String * dest = ros_message->states.data;
...
PyObject * moveit_msgs__srv__list_robot_states_in_warehouse__response__convert_to_py(void * raw_ros_message)
{
  ...
  {  // states
    ...
    rosidl_generator_c__String * src = ros_message->states.data;
