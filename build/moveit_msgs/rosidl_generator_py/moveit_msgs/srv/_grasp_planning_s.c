...
bool moveit_msgs__srv__grasp_planning__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.srv._grasp_planning.GraspPlanning_Request",
  ...
  {  // support_surfaces
    ...
    rosidl_generator_c__String * dest = ros_message->support_surfaces.data;
...
PyObject * moveit_msgs__srv__grasp_planning__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // support_surfaces
    ...
    rosidl_generator_c__String * src = ros_message->support_surfaces.data;
...
bool moveit_msgs__srv__grasp_planning__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.srv._grasp_planning.GraspPlanning_Response",
