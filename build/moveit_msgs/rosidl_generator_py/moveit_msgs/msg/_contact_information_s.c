...
bool moveit_msgs__msg__contact_information__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.msg._contact_information.ContactInformation",
  ...
  {  // contact_body_1
    ...
    rosidl_generator_c__String__assign(&ros_message->contact_body_1, PyBytes_AS_STRING(encoded_field));
  ...
  {  // contact_body_2
    ...
    rosidl_generator_c__String__assign(&ros_message->contact_body_2, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // body_type_2
