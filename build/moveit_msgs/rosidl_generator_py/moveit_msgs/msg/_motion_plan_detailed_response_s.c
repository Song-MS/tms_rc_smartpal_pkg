...
bool moveit_msgs__msg__motion_plan_detailed_response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.msg._motion_plan_detailed_response.MotionPlanDetailedResponse",
  ...
  {  // description
    ...
    rosidl_generator_c__String * dest = ros_message->description.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
...
PyObject * moveit_msgs__msg__motion_plan_detailed_response__convert_to_py(void * raw_ros_message)
{
  ...
  {  // description
    ...
    rosidl_generator_c__String * src = ros_message->description.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
