...
bool moveit_msgs__msg__attached_collision_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.msg._attached_collision_object.AttachedCollisionObject",
  ...
  {  // touch_links
    ...
    rosidl_generator_c__String * dest = ros_message->touch_links.data;
...
PyObject * moveit_msgs__msg__attached_collision_object__convert_to_py(void * raw_ros_message)
{
  ...
  {  // touch_links
    ...
    rosidl_generator_c__String * src = ros_message->touch_links.data;
