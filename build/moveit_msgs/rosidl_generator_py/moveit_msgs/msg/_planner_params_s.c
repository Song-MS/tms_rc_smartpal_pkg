...
bool moveit_msgs__msg__planner_params__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.msg._planner_params.PlannerParams",
  ...
  {  // keys
    ...
    rosidl_generator_c__String * dest = ros_message->keys.data;
  ...
  {  // values
    ...
    rosidl_generator_c__String * dest = ros_message->values.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
  ...
  {  // descriptions
    ...
    rosidl_generator_c__String * dest = ros_message->descriptions.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
...
PyObject * moveit_msgs__msg__planner_params__convert_to_py(void * raw_ros_message)
{
  ...
  {  // keys
    ...
    rosidl_generator_c__String * src = ros_message->keys.data;
  ...
  {  // values
    ...
    rosidl_generator_c__String * src = ros_message->values.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
  ...
  {  // descriptions
    ...
    rosidl_generator_c__String * src = ros_message->descriptions.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
