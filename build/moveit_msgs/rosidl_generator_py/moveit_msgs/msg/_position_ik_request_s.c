...
bool moveit_msgs__msg__position_ik_request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.msg._position_ik_request.PositionIKRequest",
  ...
  {  // ik_link_name
    ...
    rosidl_generator_c__String__assign(&ros_message->ik_link_name, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // pose_stamped
  ...
  {  // ik_link_names
    ...
    rosidl_generator_c__String * dest = ros_message->ik_link_names.data;
  ...
  {  // attempts
    ...
    ros_message->attempts = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
...
PyObject * moveit_msgs__msg__position_ik_request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // ik_link_names
    ...
    rosidl_generator_c__String * src = ros_message->ik_link_names.data;
  ...
  {  // attempts
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->attempts);
    {
