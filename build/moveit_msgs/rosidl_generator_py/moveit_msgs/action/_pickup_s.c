...
bool moveit_msgs__action__pickup__goal__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.action._pickup.Pickup_Goal",
  ...
  {  // target_name
    ...
    rosidl_generator_c__String__assign(&ros_message->target_name, PyBytes_AS_STRING(encoded_field));
  ...
  {  // group_name
    ...
    rosidl_generator_c__String__assign(&ros_message->group_name, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // end_effector
    ...
    rosidl_generator_c__String__assign(&ros_message->end_effector, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // possible_grasps
  ...
  {  // support_surface_name
    ...
    rosidl_generator_c__String__assign(&ros_message->support_surface_name, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  ...
  {  // attached_object_touch_links
    ...
    rosidl_generator_c__String * dest = ros_message->attached_object_touch_links.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
  ...
  {  // planner_id
    ...
    rosidl_generator_c__String__assign(&ros_message->planner_id, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // allowed_touch_objects
    ...
    rosidl_generator_c__String * dest = ros_message->allowed_touch_objects.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
...
PyObject * moveit_msgs__action__pickup__goal__convert_to_py(void * raw_ros_message)
{
  ...
  {  // attached_object_touch_links
    ...
    rosidl_generator_c__String * src = ros_message->attached_object_touch_links.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
  ...
  {  // allowed_touch_objects
    ...
    rosidl_generator_c__String * src = ros_message->allowed_touch_objects.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
...
bool moveit_msgs__action__pickup__result__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.action._pickup.Pickup_Result",
  ...
  {  // trajectory_descriptions
    ...
    rosidl_generator_c__String * dest = ros_message->trajectory_descriptions.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
...
PyObject * moveit_msgs__action__pickup__result__convert_to_py(void * raw_ros_message)
{
  ...
  {  // trajectory_descriptions
    ...
    rosidl_generator_c__String * src = ros_message->trajectory_descriptions.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
...
bool moveit_msgs__action__pickup__feedback__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.action._pickup.Pickup_Feedback",
...
bool moveit_msgs__action__pickup__send_goal__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.action._pickup.Pickup_SendGoal_Request",
...
bool moveit_msgs__action__pickup__send_goal__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.action._pickup.Pickup_SendGoal_Response",
...
bool moveit_msgs__action__pickup__get_result__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.action._pickup.Pickup_GetResult_Request",
        full_classname_dest, 51) == 0);
  }
...
bool moveit_msgs__action__pickup__get_result__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.action._pickup.Pickup_GetResult_Response",
...
bool moveit_msgs__action__pickup__feedback_message__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.action._pickup.Pickup_FeedbackMessage",
