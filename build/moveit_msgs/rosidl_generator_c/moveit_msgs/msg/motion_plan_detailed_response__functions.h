...
#ifndef MOVEIT_MSGS__MSG__MOTION_PLAN_DETAILED_RESPONSE__FUNCTIONS_H_
#define MOVEIT_MSGS__MSG__MOTION_PLAN_DETAILED_RESPONSE__FUNCTIONS_H_
...
#endif  // MOVEIT_MSGS__MSG__MOTION_PLAN_DETAILED_RESPONSE__FUNCTIONS_H_
