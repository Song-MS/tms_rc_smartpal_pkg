...
#ifndef MOVEIT_MSGS__MSG__POSITION_IK_REQUEST__STRUCT_H_
#define MOVEIT_MSGS__MSG__POSITION_IK_REQUEST__STRUCT_H_
...
typedef struct moveit_msgs__msg__PositionIKRequest
{
  ...
  rosidl_generator_c__String ik_link_name;
  geometry_msgs__msg__PoseStamped pose_stamped;
  rosidl_generator_c__String__Sequence ik_link_names;
...
#endif  // MOVEIT_MSGS__MSG__POSITION_IK_REQUEST__STRUCT_H_
