...
moveit_msgs__msg__AllowedCollisionMatrix__init(moveit_msgs__msg__AllowedCollisionMatrix * msg)
{
  ...
  // entry_names
  if (!rosidl_generator_c__String__Sequence__init(&msg->entry_names, 0)) {
    moveit_msgs__msg__AllowedCollisionMatrix__destroy(msg);
    return false;
  }
  // entry_values
  ...
  // default_entry_names
  if (!rosidl_generator_c__String__Sequence__init(&msg->default_entry_names, 0)) {
    moveit_msgs__msg__AllowedCollisionMatrix__destroy(msg);
    return false;
  }
  // default_entry_values
  if (!rosidl_generator_c__boolean__Sequence__init(&msg->default_entry_values, 0)) {
    moveit_msgs__msg__AllowedCollisionMatrix__destroy(msg);
    return false;
  }
  return true;
...
moveit_msgs__msg__AllowedCollisionMatrix__fini(moveit_msgs__msg__AllowedCollisionMatrix * msg)
{
  ...
  // entry_names
  rosidl_generator_c__String__Sequence__fini(&msg->entry_names);
  // entry_values
  moveit_msgs__msg__AllowedCollisionEntry__Sequence__fini(&msg->entry_values);
  // default_entry_names
  rosidl_generator_c__String__Sequence__fini(&msg->default_entry_names);
  // default_entry_values
  rosidl_generator_c__boolean__Sequence__fini(&msg->default_entry_values);
}
