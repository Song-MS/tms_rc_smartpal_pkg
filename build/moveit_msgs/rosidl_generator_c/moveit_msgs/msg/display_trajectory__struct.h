...
#ifndef MOVEIT_MSGS__MSG__DISPLAY_TRAJECTORY__STRUCT_H_
#define MOVEIT_MSGS__MSG__DISPLAY_TRAJECTORY__STRUCT_H_
...
{
  rosidl_generator_c__String model_id;
...
#endif  // MOVEIT_MSGS__MSG__DISPLAY_TRAJECTORY__STRUCT_H_
