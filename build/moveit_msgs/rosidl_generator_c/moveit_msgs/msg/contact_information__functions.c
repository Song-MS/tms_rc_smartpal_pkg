...
moveit_msgs__msg__ContactInformation__init(moveit_msgs__msg__ContactInformation * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    moveit_msgs__msg__ContactInformation__destroy(msg);
    return false;
  }
  // position
  ...
  // depth
  // contact_body_1
  if (!rosidl_generator_c__String__init(&msg->contact_body_1)) {
    moveit_msgs__msg__ContactInformation__destroy(msg);
    return false;
  }
  // body_type_1
  // contact_body_2
  if (!rosidl_generator_c__String__init(&msg->contact_body_2)) {
    moveit_msgs__msg__ContactInformation__destroy(msg);
    return false;
  }
  // body_type_2
...
moveit_msgs__msg__ContactInformation__fini(moveit_msgs__msg__ContactInformation * msg)
{
  ...
  // depth
  // contact_body_1
  rosidl_generator_c__String__fini(&msg->contact_body_1);
  // body_type_1
  // contact_body_2
  rosidl_generator_c__String__fini(&msg->contact_body_2);
  // body_type_2
}
