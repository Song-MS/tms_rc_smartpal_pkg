...
#ifndef MOVEIT_MSGS__MSG__PLANNER_PARAMS__STRUCT_H_
#define MOVEIT_MSGS__MSG__PLANNER_PARAMS__STRUCT_H_
...
{
  rosidl_generator_c__String__Sequence keys;
  rosidl_generator_c__String__Sequence values;
  rosidl_generator_c__String__Sequence descriptions;
...
#endif  // MOVEIT_MSGS__MSG__PLANNER_PARAMS__STRUCT_H_
