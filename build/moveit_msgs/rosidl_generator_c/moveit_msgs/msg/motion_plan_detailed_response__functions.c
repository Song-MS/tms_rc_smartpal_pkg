...
moveit_msgs__msg__MotionPlanDetailedResponse__init(moveit_msgs__msg__MotionPlanDetailedResponse * msg)
{
  ...
  if (!moveit_msgs__msg__RobotState__init(&msg->trajectory_start)) {
    moveit_msgs__msg__MotionPlanDetailedResponse__destroy(msg);
    return false;
  }
  // group_name
  ...
  // description
  if (!rosidl_generator_c__String__Sequence__init(&msg->description, 0)) {
    moveit_msgs__msg__MotionPlanDetailedResponse__destroy(msg);
    return false;
  }
  // processing_time
  if (!rosidl_generator_c__double__Sequence__init(&msg->processing_time, 0)) {
    moveit_msgs__msg__MotionPlanDetailedResponse__destroy(msg);
    return false;
  }
  // error_code
...
moveit_msgs__msg__MotionPlanDetailedResponse__fini(moveit_msgs__msg__MotionPlanDetailedResponse * msg)
{
  ...
  // description
  rosidl_generator_c__String__Sequence__fini(&msg->description);
  // processing_time
  rosidl_generator_c__double__Sequence__fini(&msg->processing_time);
  // error_code
