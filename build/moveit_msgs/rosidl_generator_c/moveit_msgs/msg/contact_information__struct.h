...
#ifndef MOVEIT_MSGS__MSG__CONTACT_INFORMATION__STRUCT_H_
#define MOVEIT_MSGS__MSG__CONTACT_INFORMATION__STRUCT_H_
...
typedef struct moveit_msgs__msg__ContactInformation
{
  ...
  double depth;
  rosidl_generator_c__String contact_body_1;
  uint32_t body_type_1;
  rosidl_generator_c__String contact_body_2;
...
#endif  // MOVEIT_MSGS__MSG__CONTACT_INFORMATION__STRUCT_H_
