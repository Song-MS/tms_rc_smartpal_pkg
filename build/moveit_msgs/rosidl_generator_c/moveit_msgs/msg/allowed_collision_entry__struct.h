...
#ifndef MOVEIT_MSGS__MSG__ALLOWED_COLLISION_ENTRY__STRUCT_H_
#define MOVEIT_MSGS__MSG__ALLOWED_COLLISION_ENTRY__STRUCT_H_
...
{
  rosidl_generator_c__boolean__Sequence enabled;
...
#endif  // MOVEIT_MSGS__MSG__ALLOWED_COLLISION_ENTRY__STRUCT_H_
