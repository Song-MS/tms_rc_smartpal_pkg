...
#ifndef MOVEIT_MSGS__MSG__MOTION_PLAN_DETAILED_RESPONSE__STRUCT_H_
#define MOVEIT_MSGS__MSG__MOTION_PLAN_DETAILED_RESPONSE__STRUCT_H_
...
typedef struct moveit_msgs__msg__MotionPlanDetailedResponse
{
  ...
  rosidl_generator_c__String__Sequence description;
  rosidl_generator_c__double__Sequence processing_time;
...
#endif  // MOVEIT_MSGS__MSG__MOTION_PLAN_DETAILED_RESPONSE__STRUCT_H_
