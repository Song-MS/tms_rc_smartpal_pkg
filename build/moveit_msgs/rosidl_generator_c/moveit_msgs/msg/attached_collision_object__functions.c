...
moveit_msgs__msg__AttachedCollisionObject__init(moveit_msgs__msg__AttachedCollisionObject * msg)
{
  ...
  if (!rosidl_generator_c__String__init(&msg->link_name)) {
    moveit_msgs__msg__AttachedCollisionObject__destroy(msg);
    return false;
  }
  // object
  ...
  // touch_links
  if (!rosidl_generator_c__String__Sequence__init(&msg->touch_links, 0)) {
    moveit_msgs__msg__AttachedCollisionObject__destroy(msg);
    return false;
  }
  // detach_posture
...
moveit_msgs__msg__AttachedCollisionObject__fini(moveit_msgs__msg__AttachedCollisionObject * msg)
{
  ...
  // touch_links
  rosidl_generator_c__String__Sequence__fini(&msg->touch_links);
  // detach_posture
