...
#ifndef MOVEIT_MSGS__MSG__ALLOWED_COLLISION_MATRIX__STRUCT_H_
#define MOVEIT_MSGS__MSG__ALLOWED_COLLISION_MATRIX__STRUCT_H_
...
{
  rosidl_generator_c__String__Sequence entry_names;
  moveit_msgs__msg__AllowedCollisionEntry__Sequence entry_values;
  rosidl_generator_c__String__Sequence default_entry_names;
  rosidl_generator_c__boolean__Sequence default_entry_values;
...
#endif  // MOVEIT_MSGS__MSG__ALLOWED_COLLISION_MATRIX__STRUCT_H_
