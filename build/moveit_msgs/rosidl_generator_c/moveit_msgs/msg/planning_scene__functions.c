...
moveit_msgs__msg__PlanningScene__init(moveit_msgs__msg__PlanningScene * msg)
{
  ...
  if (!rosidl_generator_c__String__init(&msg->name)) {
    moveit_msgs__msg__PlanningScene__destroy(msg);
    return false;
  }
  // robot_state
  ...
  // robot_model_name
  if (!rosidl_generator_c__String__init(&msg->robot_model_name)) {
    moveit_msgs__msg__PlanningScene__destroy(msg);
    return false;
  }
...
moveit_msgs__msg__PlanningScene__fini(moveit_msgs__msg__PlanningScene * msg)
{
  ...
  // robot_model_name
  rosidl_generator_c__String__fini(&msg->robot_model_name);
  // fixed_frame_transforms
