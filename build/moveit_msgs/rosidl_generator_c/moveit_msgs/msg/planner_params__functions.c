...
moveit_msgs__msg__PlannerParams__init(moveit_msgs__msg__PlannerParams * msg)
{
  ...
  // keys
  if (!rosidl_generator_c__String__Sequence__init(&msg->keys, 0)) {
    moveit_msgs__msg__PlannerParams__destroy(msg);
    return false;
  }
  // values
  if (!rosidl_generator_c__String__Sequence__init(&msg->values, 0)) {
    moveit_msgs__msg__PlannerParams__destroy(msg);
    return false;
  }
  // descriptions
  if (!rosidl_generator_c__String__Sequence__init(&msg->descriptions, 0)) {
    moveit_msgs__msg__PlannerParams__destroy(msg);
    return false;
  }
  return true;
...
moveit_msgs__msg__PlannerParams__fini(moveit_msgs__msg__PlannerParams * msg)
{
  ...
  // keys
  rosidl_generator_c__String__Sequence__fini(&msg->keys);
  // values
  rosidl_generator_c__String__Sequence__fini(&msg->values);
  // descriptions
  rosidl_generator_c__String__Sequence__fini(&msg->descriptions);
}
