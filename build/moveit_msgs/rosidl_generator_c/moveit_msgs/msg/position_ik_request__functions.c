...
moveit_msgs__msg__PositionIKRequest__init(moveit_msgs__msg__PositionIKRequest * msg)
{
  ...
  if (!rosidl_generator_c__String__init(&msg->group_name)) {
    moveit_msgs__msg__PositionIKRequest__destroy(msg);
    return false;
  }
  // robot_state
  ...
  // avoid_collisions
  // ik_link_name
  if (!rosidl_generator_c__String__init(&msg->ik_link_name)) {
    moveit_msgs__msg__PositionIKRequest__destroy(msg);
    return false;
  }
  // pose_stamped
  ...
  // ik_link_names
  if (!rosidl_generator_c__String__Sequence__init(&msg->ik_link_names, 0)) {
    moveit_msgs__msg__PositionIKRequest__destroy(msg);
    return false;
  }
  // pose_stamped_vector
...
moveit_msgs__msg__PositionIKRequest__fini(moveit_msgs__msg__PositionIKRequest * msg)
{
  ...
  // avoid_collisions
  // ik_link_name
  rosidl_generator_c__String__fini(&msg->ik_link_name);
  // pose_stamped
  geometry_msgs__msg__PoseStamped__fini(&msg->pose_stamped);
  // ik_link_names
  rosidl_generator_c__String__Sequence__fini(&msg->ik_link_names);
  // pose_stamped_vector
