...
moveit_msgs__msg__AllowedCollisionEntry__init(moveit_msgs__msg__AllowedCollisionEntry * msg)
{
  ...
  // enabled
  if (!rosidl_generator_c__boolean__Sequence__init(&msg->enabled, 0)) {
    moveit_msgs__msg__AllowedCollisionEntry__destroy(msg);
    return false;
  }
  return true;
}
...
moveit_msgs__msg__AllowedCollisionEntry__fini(moveit_msgs__msg__AllowedCollisionEntry * msg)
{
  ...
  // enabled
  rosidl_generator_c__boolean__Sequence__fini(&msg->enabled);
}
