...
moveit_msgs__msg__PlannerInterfaceDescription__init(moveit_msgs__msg__PlannerInterfaceDescription * msg)
{
  ...
  if (!rosidl_generator_c__String__init(&msg->name)) {
    moveit_msgs__msg__PlannerInterfaceDescription__destroy(msg);
    return false;
  }
  // planner_ids
  if (!rosidl_generator_c__String__Sequence__init(&msg->planner_ids, 0)) {
    moveit_msgs__msg__PlannerInterfaceDescription__destroy(msg);
    return false;
  }
  return true;
...
moveit_msgs__msg__PlannerInterfaceDescription__fini(moveit_msgs__msg__PlannerInterfaceDescription * msg)
{
  ...
  // planner_ids
  rosidl_generator_c__String__Sequence__fini(&msg->planner_ids);
}
