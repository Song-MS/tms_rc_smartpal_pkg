...
moveit_msgs__msg__CartesianTrajectory__init(moveit_msgs__msg__CartesianTrajectory * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    moveit_msgs__msg__CartesianTrajectory__destroy(msg);
    return false;
  }
  // tracked_frame
  if (!rosidl_generator_c__String__init(&msg->tracked_frame)) {
    moveit_msgs__msg__CartesianTrajectory__destroy(msg);
    return false;
  }
  // points
...
moveit_msgs__msg__CartesianTrajectory__fini(moveit_msgs__msg__CartesianTrajectory * msg)
{
  ...
  // tracked_frame
  rosidl_generator_c__String__fini(&msg->tracked_frame);
  // points
