...
#ifndef MOVEIT_MSGS__SRV__SAVE_ROBOT_STATE_TO_WAREHOUSE__FUNCTIONS_H_
#define MOVEIT_MSGS__SRV__SAVE_ROBOT_STATE_TO_WAREHOUSE__FUNCTIONS_H_
...
#endif  // MOVEIT_MSGS__SRV__SAVE_ROBOT_STATE_TO_WAREHOUSE__FUNCTIONS_H_
