...
#ifndef MOVEIT_MSGS__SRV__CHECK_IF_ROBOT_STATE_EXISTS_IN_WAREHOUSE__STRUCT_H_
#define MOVEIT_MSGS__SRV__CHECK_IF_ROBOT_STATE_EXISTS_IN_WAREHOUSE__STRUCT_H_
...
#endif  // MOVEIT_MSGS__SRV__CHECK_IF_ROBOT_STATE_EXISTS_IN_WAREHOUSE__STRUCT_H_
