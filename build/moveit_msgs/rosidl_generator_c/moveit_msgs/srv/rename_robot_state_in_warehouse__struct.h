...
#ifndef MOVEIT_MSGS__SRV__RENAME_ROBOT_STATE_IN_WAREHOUSE__STRUCT_H_
#define MOVEIT_MSGS__SRV__RENAME_ROBOT_STATE_IN_WAREHOUSE__STRUCT_H_
...
{
  rosidl_generator_c__String old_name;
  rosidl_generator_c__String new_name;
...
#endif  // MOVEIT_MSGS__SRV__RENAME_ROBOT_STATE_IN_WAREHOUSE__STRUCT_H_
