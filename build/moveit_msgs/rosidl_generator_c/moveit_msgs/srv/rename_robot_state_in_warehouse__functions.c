...
moveit_msgs__srv__RenameRobotStateInWarehouse_Request__init(moveit_msgs__srv__RenameRobotStateInWarehouse_Request * msg)
{
  ...
  // old_name
  if (!rosidl_generator_c__String__init(&msg->old_name)) {
    moveit_msgs__srv__RenameRobotStateInWarehouse_Request__destroy(msg);
    return false;
  }
  // new_name
  if (!rosidl_generator_c__String__init(&msg->new_name)) {
    moveit_msgs__srv__RenameRobotStateInWarehouse_Request__destroy(msg);
    return false;
  }
  // robot
...
moveit_msgs__srv__RenameRobotStateInWarehouse_Request__fini(moveit_msgs__srv__RenameRobotStateInWarehouse_Request * msg)
{
  ...
  // old_name
  rosidl_generator_c__String__fini(&msg->old_name);
  // new_name
  rosidl_generator_c__String__fini(&msg->new_name);
  // robot
