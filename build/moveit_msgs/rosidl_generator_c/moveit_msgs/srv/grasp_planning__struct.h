...
#ifndef MOVEIT_MSGS__SRV__GRASP_PLANNING__STRUCT_H_
#define MOVEIT_MSGS__SRV__GRASP_PLANNING__STRUCT_H_
...
typedef struct moveit_msgs__srv__GraspPlanning_Request
{
  ...
  rosidl_generator_c__String__Sequence support_surfaces;
...
#endif  // MOVEIT_MSGS__SRV__GRASP_PLANNING__STRUCT_H_
