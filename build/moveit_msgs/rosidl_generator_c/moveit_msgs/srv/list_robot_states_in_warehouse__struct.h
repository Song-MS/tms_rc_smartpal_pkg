...
#ifndef MOVEIT_MSGS__SRV__LIST_ROBOT_STATES_IN_WAREHOUSE__STRUCT_H_
#define MOVEIT_MSGS__SRV__LIST_ROBOT_STATES_IN_WAREHOUSE__STRUCT_H_
...
{
  rosidl_generator_c__String regex;
  rosidl_generator_c__String robot;
...
{
  rosidl_generator_c__String__Sequence states;
...
#endif  // MOVEIT_MSGS__SRV__LIST_ROBOT_STATES_IN_WAREHOUSE__STRUCT_H_
