...
#ifndef MOVEIT_MSGS__SRV__GET_STATE_VALIDITY__FUNCTIONS_H_
#define MOVEIT_MSGS__SRV__GET_STATE_VALIDITY__FUNCTIONS_H_
...
#endif  // MOVEIT_MSGS__SRV__GET_STATE_VALIDITY__FUNCTIONS_H_
