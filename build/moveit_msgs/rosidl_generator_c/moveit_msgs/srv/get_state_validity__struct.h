...
#ifndef MOVEIT_MSGS__SRV__GET_STATE_VALIDITY__STRUCT_H_
#define MOVEIT_MSGS__SRV__GET_STATE_VALIDITY__STRUCT_H_
...
#endif  // MOVEIT_MSGS__SRV__GET_STATE_VALIDITY__STRUCT_H_
