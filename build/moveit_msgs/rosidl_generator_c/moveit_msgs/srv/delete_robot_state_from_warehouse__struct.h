...
#ifndef MOVEIT_MSGS__SRV__DELETE_ROBOT_STATE_FROM_WAREHOUSE__STRUCT_H_
#define MOVEIT_MSGS__SRV__DELETE_ROBOT_STATE_FROM_WAREHOUSE__STRUCT_H_
...
#endif  // MOVEIT_MSGS__SRV__DELETE_ROBOT_STATE_FROM_WAREHOUSE__STRUCT_H_
