...
#ifndef MOVEIT_MSGS__SRV__GET_ROBOT_STATE_FROM_WAREHOUSE__STRUCT_H_
#define MOVEIT_MSGS__SRV__GET_ROBOT_STATE_FROM_WAREHOUSE__STRUCT_H_
...
#endif  // MOVEIT_MSGS__SRV__GET_ROBOT_STATE_FROM_WAREHOUSE__STRUCT_H_
