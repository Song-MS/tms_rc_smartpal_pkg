...
#ifndef MOVEIT_MSGS__SRV__GET_POSITION_FK__STRUCT_H_
#define MOVEIT_MSGS__SRV__GET_POSITION_FK__STRUCT_H_
...
typedef struct moveit_msgs__srv__GetPositionFK_Request
{
  ...
  rosidl_generator_c__String__Sequence fk_link_names;
...
#endif  // MOVEIT_MSGS__SRV__GET_POSITION_FK__STRUCT_H_
