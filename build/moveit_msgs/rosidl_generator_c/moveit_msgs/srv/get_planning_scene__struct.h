...
#ifndef MOVEIT_MSGS__SRV__GET_PLANNING_SCENE__STRUCT_H_
#define MOVEIT_MSGS__SRV__GET_PLANNING_SCENE__STRUCT_H_
...
#endif  // MOVEIT_MSGS__SRV__GET_PLANNING_SCENE__STRUCT_H_
