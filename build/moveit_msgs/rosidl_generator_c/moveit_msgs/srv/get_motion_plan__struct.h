...
#ifndef MOVEIT_MSGS__SRV__GET_MOTION_PLAN__STRUCT_H_
#define MOVEIT_MSGS__SRV__GET_MOTION_PLAN__STRUCT_H_
...
#endif  // MOVEIT_MSGS__SRV__GET_MOTION_PLAN__STRUCT_H_
