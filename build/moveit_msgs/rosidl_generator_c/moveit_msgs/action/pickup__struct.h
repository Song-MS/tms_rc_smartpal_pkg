...
#ifndef MOVEIT_MSGS__ACTION__PICKUP__STRUCT_H_
#define MOVEIT_MSGS__ACTION__PICKUP__STRUCT_H_
...
{
  rosidl_generator_c__String target_name;
  rosidl_generator_c__String group_name;
  rosidl_generator_c__String end_effector;
  moveit_msgs__msg__Grasp__Sequence possible_grasps;
  rosidl_generator_c__String support_surface_name;
  bool allow_gripper_support_collision;
  rosidl_generator_c__String__Sequence attached_object_touch_links;
  bool minimize_object_distance;
  moveit_msgs__msg__Constraints path_constraints;
  rosidl_generator_c__String planner_id;
  rosidl_generator_c__String__Sequence allowed_touch_objects;
...
typedef struct moveit_msgs__action__Pickup_Result
{
  ...
  rosidl_generator_c__String__Sequence trajectory_descriptions;
...
#endif  // MOVEIT_MSGS__ACTION__PICKUP__STRUCT_H_
