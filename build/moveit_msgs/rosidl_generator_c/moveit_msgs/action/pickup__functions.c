...
moveit_msgs__action__Pickup_Goal__init(moveit_msgs__action__Pickup_Goal * msg)
{
  ...
  // target_name
  if (!rosidl_generator_c__String__init(&msg->target_name)) {
    moveit_msgs__action__Pickup_Goal__destroy(msg);
    return false;
  }
  // group_name
  ...
  // end_effector
  if (!rosidl_generator_c__String__init(&msg->end_effector)) {
    moveit_msgs__action__Pickup_Goal__destroy(msg);
    return false;
  }
  // possible_grasps
  ...
  if (!rosidl_generator_c__String__Sequence__init(&msg->attached_object_touch_links, 0)) {
    moveit_msgs__action__Pickup_Goal__destroy(msg);
    return false;
  }
...
moveit_msgs__action__Pickup_Goal__fini(moveit_msgs__action__Pickup_Goal * msg)
{
  ...
  // target_name
  rosidl_generator_c__String__fini(&msg->target_name);
  // group_name
  rosidl_generator_c__String__fini(&msg->group_name);
  // end_effector
  rosidl_generator_c__String__fini(&msg->end_effector);
  // possible_grasps
  ...
  // allow_gripper_support_collision
  // attached_object_touch_links
  rosidl_generator_c__String__Sequence__fini(&msg->attached_object_touch_links);
  // minimize_object_distance
  // path_constraints
...
moveit_msgs__action__Pickup_Result__init(moveit_msgs__action__Pickup_Result * msg)
{
  ...
  if (!moveit_msgs__msg__MoveItErrorCodes__init(&msg->error_code)) {
    moveit_msgs__action__Pickup_Result__destroy(msg);
    return false;
  }
  // trajectory_start
...
moveit_msgs__action__Pickup_Feedback__init(moveit_msgs__action__Pickup_Feedback * msg)
{
  ...
  if (!rosidl_generator_c__String__init(&msg->state)) {
    moveit_msgs__action__Pickup_Feedback__destroy(msg);
    return false;
  }
  return true;
}
...
moveit_msgs__action__Pickup_SendGoal_Request__init(moveit_msgs__action__Pickup_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    moveit_msgs__action__Pickup_SendGoal_Request__destroy(msg);
    return false;
  }
  // goal
...
moveit_msgs__action__Pickup_SendGoal_Response__init(moveit_msgs__action__Pickup_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    moveit_msgs__action__Pickup_SendGoal_Response__destroy(msg);
    return false;
  }
  return true;
}
...
moveit_msgs__action__Pickup_GetResult_Request__init(moveit_msgs__action__Pickup_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    moveit_msgs__action__Pickup_GetResult_Request__destroy(msg);
    return false;
  }
  return true;
}
...
moveit_msgs__action__Pickup_GetResult_Response__init(moveit_msgs__action__Pickup_GetResult_Response * msg)
{
  ...
  if (!moveit_msgs__action__Pickup_Result__init(&msg->result)) {
    moveit_msgs__action__Pickup_GetResult_Response__destroy(msg);
    return false;
  }
  return true;
}
...
moveit_msgs__action__Pickup_FeedbackMessage__init(moveit_msgs__action__Pickup_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    moveit_msgs__action__Pickup_FeedbackMessage__destroy(msg);
    return false;
  }
  // feedback
