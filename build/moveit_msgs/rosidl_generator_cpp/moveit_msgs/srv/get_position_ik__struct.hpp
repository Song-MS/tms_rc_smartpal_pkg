...
#ifndef MOVEIT_MSGS__SRV__GET_POSITION_IK__STRUCT_HPP_
#define MOVEIT_MSGS__SRV__GET_POSITION_IK__STRUCT_HPP_
...
// Member 'ik_request'
#include "moveit_msgs/msg/position_ik_request__struct.hpp"
...
struct GetPositionIK_Request_
{
  ...
  explicit GetPositionIK_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : ik_request(_init)
  {
    (void)_init;
  }

  explicit GetPositionIK_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
struct GetPositionIK_Response_
{
  ...
  explicit GetPositionIK_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : solution(_init),
    error_code(_init)
  {
    (void)_init;
  ...
  explicit GetPositionIK_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // MOVEIT_MSGS__SRV__GET_POSITION_IK__STRUCT_HPP_
