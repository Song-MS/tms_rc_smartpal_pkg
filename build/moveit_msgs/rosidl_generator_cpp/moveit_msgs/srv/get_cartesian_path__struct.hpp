...
#ifndef MOVEIT_MSGS__SRV__GET_CARTESIAN_PATH__STRUCT_HPP_
#define MOVEIT_MSGS__SRV__GET_CARTESIAN_PATH__STRUCT_HPP_
...
struct GetCartesianPath_Request_
{
  ...
  explicit GetCartesianPath_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    start_state(_init),
  ...
  explicit GetCartesianPath_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
...
struct GetCartesianPath_Response_
{
  ...
  explicit GetCartesianPath_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : start_state(_init),
    solution(_init),
    error_code(_init)
  {
  ...
  explicit GetCartesianPath_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : start_state(_alloc, _init),
...
#endif  // MOVEIT_MSGS__SRV__GET_CARTESIAN_PATH__STRUCT_HPP_
