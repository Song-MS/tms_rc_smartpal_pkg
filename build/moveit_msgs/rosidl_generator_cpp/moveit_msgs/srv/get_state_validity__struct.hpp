...
#ifndef MOVEIT_MSGS__SRV__GET_STATE_VALIDITY__STRUCT_HPP_
#define MOVEIT_MSGS__SRV__GET_STATE_VALIDITY__STRUCT_HPP_
...
struct GetStateValidity_Request_
{
  ...
  explicit GetStateValidity_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : robot_state(_init),
    constraints(_init)
  {
  ...
  explicit GetStateValidity_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
struct GetStateValidity_Response_
{
  ...
  explicit GetStateValidity_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  explicit GetStateValidity_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // MOVEIT_MSGS__SRV__GET_STATE_VALIDITY__STRUCT_HPP_
