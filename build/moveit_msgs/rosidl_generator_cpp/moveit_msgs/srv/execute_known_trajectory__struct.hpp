...
#ifndef MOVEIT_MSGS__SRV__EXECUTE_KNOWN_TRAJECTORY__STRUCT_HPP_
#define MOVEIT_MSGS__SRV__EXECUTE_KNOWN_TRAJECTORY__STRUCT_HPP_
...
struct ExecuteKnownTrajectory_Request_
{
  ...
  explicit ExecuteKnownTrajectory_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : trajectory(_init)
  {
  ...
  explicit ExecuteKnownTrajectory_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
struct ExecuteKnownTrajectory_Response_
{
  ...
  explicit ExecuteKnownTrajectory_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : error_code(_init)
  {
    (void)_init;
  }

  explicit ExecuteKnownTrajectory_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // MOVEIT_MSGS__SRV__EXECUTE_KNOWN_TRAJECTORY__STRUCT_HPP_
