...
#ifndef MOVEIT_MSGS__SRV__GET_POSITION_FK__STRUCT_HPP_
#define MOVEIT_MSGS__SRV__GET_POSITION_FK__STRUCT_HPP_
...
struct GetPositionFK_Request_
{
  ...
  explicit GetPositionFK_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    robot_state(_init)
  {
    (void)_init;
  ...
  explicit GetPositionFK_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
...
struct GetPositionFK_Response_
{
  ...
  explicit GetPositionFK_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : error_code(_init)
  {
    (void)_init;
  }

  explicit GetPositionFK_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // MOVEIT_MSGS__SRV__GET_POSITION_FK__STRUCT_HPP_
