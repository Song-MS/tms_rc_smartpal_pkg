...
#ifndef MOVEIT_MSGS__SRV__GET_MOTION_PLAN__STRUCT_HPP_
#define MOVEIT_MSGS__SRV__GET_MOTION_PLAN__STRUCT_HPP_
...
struct GetMotionPlan_Request_
{
  ...
  explicit GetMotionPlan_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : motion_plan_request(_init)
  {
    (void)_init;
  }

  explicit GetMotionPlan_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
struct GetMotionPlan_Response_
{
  ...
  explicit GetMotionPlan_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : motion_plan_response(_init)
  {
    (void)_init;
  }

  explicit GetMotionPlan_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // MOVEIT_MSGS__SRV__GET_MOTION_PLAN__STRUCT_HPP_
