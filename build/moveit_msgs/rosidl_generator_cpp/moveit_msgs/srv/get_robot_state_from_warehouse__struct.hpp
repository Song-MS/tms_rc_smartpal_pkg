...
#ifndef MOVEIT_MSGS__SRV__GET_ROBOT_STATE_FROM_WAREHOUSE__STRUCT_HPP_
#define MOVEIT_MSGS__SRV__GET_ROBOT_STATE_FROM_WAREHOUSE__STRUCT_HPP_
...
struct GetRobotStateFromWarehouse_Request_
{
  ...
  explicit GetRobotStateFromWarehouse_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit GetRobotStateFromWarehouse_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : name(_alloc),
    robot(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
...
struct GetRobotStateFromWarehouse_Response_
{
  ...
  explicit GetRobotStateFromWarehouse_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : state(_init)
  {
    (void)_init;
  }

  explicit GetRobotStateFromWarehouse_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : state(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // MOVEIT_MSGS__SRV__GET_ROBOT_STATE_FROM_WAREHOUSE__STRUCT_HPP_
