...
#ifndef MOVEIT_MSGS__SRV__RENAME_ROBOT_STATE_IN_WAREHOUSE__STRUCT_HPP_
#define MOVEIT_MSGS__SRV__RENAME_ROBOT_STATE_IN_WAREHOUSE__STRUCT_HPP_
...
struct RenameRobotStateInWarehouse_Request_
{
  ...
  explicit RenameRobotStateInWarehouse_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit RenameRobotStateInWarehouse_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : old_name(_alloc),
    new_name(_alloc),
    robot(_alloc)
  {
...
struct RenameRobotStateInWarehouse_Response_
{
  ...
  explicit RenameRobotStateInWarehouse_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  explicit RenameRobotStateInWarehouse_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // MOVEIT_MSGS__SRV__RENAME_ROBOT_STATE_IN_WAREHOUSE__STRUCT_HPP_
