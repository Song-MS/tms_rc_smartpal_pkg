...
#ifndef MOVEIT_MSGS__SRV__APPLY_PLANNING_SCENE__STRUCT_HPP_
#define MOVEIT_MSGS__SRV__APPLY_PLANNING_SCENE__STRUCT_HPP_
...
struct ApplyPlanningScene_Request_
{
  ...
  explicit ApplyPlanningScene_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : scene(_init)
  {
    (void)_init;
  }

  explicit ApplyPlanningScene_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : scene(_alloc, _init)
  {
    (void)_init;
  }
...
struct ApplyPlanningScene_Response_
{
  ...
  explicit ApplyPlanningScene_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit ApplyPlanningScene_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // MOVEIT_MSGS__SRV__APPLY_PLANNING_SCENE__STRUCT_HPP_
