...
#ifndef MOVEIT_MSGS__SRV__LIST_ROBOT_STATES_IN_WAREHOUSE__STRUCT_HPP_
#define MOVEIT_MSGS__SRV__LIST_ROBOT_STATES_IN_WAREHOUSE__STRUCT_HPP_
...
struct ListRobotStatesInWarehouse_Request_
{
  ...
  explicit ListRobotStatesInWarehouse_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit ListRobotStatesInWarehouse_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : regex(_alloc),
    robot(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
...
struct ListRobotStatesInWarehouse_Response_
{
  ...
  explicit ListRobotStatesInWarehouse_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit ListRobotStatesInWarehouse_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
...
#endif  // MOVEIT_MSGS__SRV__LIST_ROBOT_STATES_IN_WAREHOUSE__STRUCT_HPP_
