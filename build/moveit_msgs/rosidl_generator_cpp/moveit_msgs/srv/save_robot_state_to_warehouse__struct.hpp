...
#ifndef MOVEIT_MSGS__SRV__SAVE_ROBOT_STATE_TO_WAREHOUSE__STRUCT_HPP_
#define MOVEIT_MSGS__SRV__SAVE_ROBOT_STATE_TO_WAREHOUSE__STRUCT_HPP_
...
struct SaveRobotStateToWarehouse_Request_
{
  ...
  explicit SaveRobotStateToWarehouse_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : state(_init)
  {
  ...
  explicit SaveRobotStateToWarehouse_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : name(_alloc),
    robot(_alloc),
    state(_alloc, _init)
  {
...
struct SaveRobotStateToWarehouse_Response_
{
  ...
  explicit SaveRobotStateToWarehouse_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
    {
  ...
  explicit SaveRobotStateToWarehouse_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // MOVEIT_MSGS__SRV__SAVE_ROBOT_STATE_TO_WAREHOUSE__STRUCT_HPP_
