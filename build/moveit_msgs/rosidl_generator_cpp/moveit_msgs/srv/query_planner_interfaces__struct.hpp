...
#ifndef MOVEIT_MSGS__SRV__QUERY_PLANNER_INTERFACES__STRUCT_HPP_
#define MOVEIT_MSGS__SRV__QUERY_PLANNER_INTERFACES__STRUCT_HPP_
...
struct QueryPlannerInterfaces_Request_
{
  ...
  explicit QueryPlannerInterfaces_Request_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit QueryPlannerInterfaces_Request_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#include "moveit_msgs/msg/planner_interface_description__struct.hpp"
...
struct QueryPlannerInterfaces_Response_
{
  ...
  explicit QueryPlannerInterfaces_Response_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit QueryPlannerInterfaces_Response_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
...
#endif  // MOVEIT_MSGS__SRV__QUERY_PLANNER_INTERFACES__STRUCT_HPP_
