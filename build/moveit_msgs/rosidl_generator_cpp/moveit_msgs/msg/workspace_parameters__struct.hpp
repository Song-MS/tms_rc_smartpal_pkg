...
#ifndef MOVEIT_MSGS__MSG__WORKSPACE_PARAMETERS__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__WORKSPACE_PARAMETERS__STRUCT_HPP_
...
struct WorkspaceParameters_
{
  ...
  explicit WorkspaceParameters_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    min_corner(_init),
    max_corner(_init)
  {
  ...
  explicit WorkspaceParameters_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
...
#endif  // MOVEIT_MSGS__MSG__WORKSPACE_PARAMETERS__STRUCT_HPP_
