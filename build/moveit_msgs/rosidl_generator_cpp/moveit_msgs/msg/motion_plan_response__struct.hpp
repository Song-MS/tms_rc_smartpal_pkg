...
#ifndef MOVEIT_MSGS__MSG__MOTION_PLAN_RESPONSE__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__MOTION_PLAN_RESPONSE__STRUCT_HPP_
...
struct MotionPlanResponse_
{
  ...
  explicit MotionPlanResponse_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  ...
  explicit MotionPlanResponse_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // MOVEIT_MSGS__MSG__MOTION_PLAN_RESPONSE__STRUCT_HPP_
