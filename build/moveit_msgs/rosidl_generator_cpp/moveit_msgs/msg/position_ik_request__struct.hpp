...
#ifndef MOVEIT_MSGS__MSG__POSITION_IK_REQUEST__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__POSITION_IK_REQUEST__STRUCT_HPP_
...
struct PositionIKRequest_
{
  ...
  explicit PositionIKRequest_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : robot_state(_init),
    constraints(_init),
    pose_stamped(_init),
    timeout(_init)
  ...
  explicit PositionIKRequest_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : group_name(_alloc),
...
#endif  // MOVEIT_MSGS__MSG__POSITION_IK_REQUEST__STRUCT_HPP_
