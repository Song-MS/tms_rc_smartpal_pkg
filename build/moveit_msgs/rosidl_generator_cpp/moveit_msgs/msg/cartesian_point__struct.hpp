...
#ifndef MOVEIT_MSGS__MSG__CARTESIAN_POINT__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__CARTESIAN_POINT__STRUCT_HPP_
...
struct CartesianPoint_
{
  ...
  explicit CartesianPoint_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : pose(_init),
    velocity(_init),
    acceleration(_init)
  {
  ...
  explicit CartesianPoint_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : pose(_alloc, _init),
...
#endif  // MOVEIT_MSGS__MSG__CARTESIAN_POINT__STRUCT_HPP_
