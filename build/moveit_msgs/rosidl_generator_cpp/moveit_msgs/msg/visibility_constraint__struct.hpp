...
#ifndef MOVEIT_MSGS__MSG__VISIBILITY_CONSTRAINT__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__VISIBILITY_CONSTRAINT__STRUCT_HPP_
...
struct VisibilityConstraint_
{
  ...
  explicit VisibilityConstraint_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : target_pose(_init),
    sensor_pose(_init)
  {
  ...
  explicit VisibilityConstraint_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // MOVEIT_MSGS__MSG__VISIBILITY_CONSTRAINT__STRUCT_HPP_
