...
#ifndef MOVEIT_MSGS__MSG__POSITION_CONSTRAINT__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__POSITION_CONSTRAINT__STRUCT_HPP_
...
struct PositionConstraint_
{
  ...
  explicit PositionConstraint_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
  ...
  explicit PositionConstraint_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
    link_name(_alloc),
...
#endif  // MOVEIT_MSGS__MSG__POSITION_CONSTRAINT__STRUCT_HPP_
