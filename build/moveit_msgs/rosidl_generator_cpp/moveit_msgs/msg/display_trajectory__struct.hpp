...
#ifndef MOVEIT_MSGS__MSG__DISPLAY_TRAJECTORY__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__DISPLAY_TRAJECTORY__STRUCT_HPP_
...
struct DisplayTrajectory_
{
  ...
  explicit DisplayTrajectory_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  ...
  explicit DisplayTrajectory_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : model_id(_alloc),
...
#endif  // MOVEIT_MSGS__MSG__DISPLAY_TRAJECTORY__STRUCT_HPP_
