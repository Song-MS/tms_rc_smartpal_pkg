...
#ifndef MOVEIT_MSGS__MSG__PLANNING_OPTIONS__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__PLANNING_OPTIONS__STRUCT_HPP_
...
struct PlanningOptions_
{
  ...
  explicit PlanningOptions_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  ...
  explicit PlanningOptions_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // MOVEIT_MSGS__MSG__PLANNING_OPTIONS__STRUCT_HPP_
