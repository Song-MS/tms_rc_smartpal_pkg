...
#ifndef MOVEIT_MSGS__MSG__COST_SOURCE__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__COST_SOURCE__STRUCT_HPP_
...
struct CostSource_
{
  ...
  explicit CostSource_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : aabb_min(_init),
    aabb_max(_init)
  {
  ...
  explicit CostSource_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // MOVEIT_MSGS__MSG__COST_SOURCE__STRUCT_HPP_
