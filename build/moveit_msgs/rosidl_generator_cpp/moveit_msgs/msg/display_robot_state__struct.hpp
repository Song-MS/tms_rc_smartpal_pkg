...
#ifndef MOVEIT_MSGS__MSG__DISPLAY_ROBOT_STATE__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__DISPLAY_ROBOT_STATE__STRUCT_HPP_
...
struct DisplayRobotState_
{
  ...
  explicit DisplayRobotState_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : state(_init)
  {
  ...
  explicit DisplayRobotState_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : state(_alloc, _init)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // MOVEIT_MSGS__MSG__DISPLAY_ROBOT_STATE__STRUCT_HPP_
