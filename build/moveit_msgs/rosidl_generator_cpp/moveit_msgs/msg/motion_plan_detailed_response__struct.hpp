...
#ifndef MOVEIT_MSGS__MSG__MOTION_PLAN_DETAILED_RESPONSE__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__MOTION_PLAN_DETAILED_RESPONSE__STRUCT_HPP_
...
struct MotionPlanDetailedResponse_
{
  ...
  explicit MotionPlanDetailedResponse_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  ...
  explicit MotionPlanDetailedResponse_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // MOVEIT_MSGS__MSG__MOTION_PLAN_DETAILED_RESPONSE__STRUCT_HPP_
