...
#ifndef MOVEIT_MSGS__MSG__PLANNING_SCENE_WORLD__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__PLANNING_SCENE_WORLD__STRUCT_HPP_
...
struct PlanningSceneWorld_
{
  ...
  explicit PlanningSceneWorld_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : octomap(_init)
  {
    (void)_init;
  }

  explicit PlanningSceneWorld_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // MOVEIT_MSGS__MSG__PLANNING_SCENE_WORLD__STRUCT_HPP_
