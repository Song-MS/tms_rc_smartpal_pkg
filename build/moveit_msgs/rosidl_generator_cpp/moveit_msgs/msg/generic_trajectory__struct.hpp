...
#ifndef MOVEIT_MSGS__MSG__GENERIC_TRAJECTORY__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__GENERIC_TRAJECTORY__STRUCT_HPP_
...
struct GenericTrajectory_
{
  ...
  explicit GenericTrajectory_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init)
  {
    (void)_init;
  }

  explicit GenericTrajectory_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init)
  {
    (void)_init;
  }
...
#endif  // MOVEIT_MSGS__MSG__GENERIC_TRAJECTORY__STRUCT_HPP_
