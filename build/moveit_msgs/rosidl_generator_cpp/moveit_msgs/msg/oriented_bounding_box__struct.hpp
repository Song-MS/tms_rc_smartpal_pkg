...
#ifndef MOVEIT_MSGS__MSG__ORIENTED_BOUNDING_BOX__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__ORIENTED_BOUNDING_BOX__STRUCT_HPP_
...
struct OrientedBoundingBox_
{
  ...
  explicit OrientedBoundingBox_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : pose(_init),
    extents(_init)
  {
    (void)_init;
  ...
  explicit OrientedBoundingBox_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : pose(_alloc, _init),
...
#endif  // MOVEIT_MSGS__MSG__ORIENTED_BOUNDING_BOX__STRUCT_HPP_
