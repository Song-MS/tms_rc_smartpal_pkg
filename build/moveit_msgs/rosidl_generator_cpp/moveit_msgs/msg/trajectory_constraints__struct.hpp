...
#ifndef MOVEIT_MSGS__MSG__TRAJECTORY_CONSTRAINTS__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__TRAJECTORY_CONSTRAINTS__STRUCT_HPP_
...
struct TrajectoryConstraints_
{
  ...
  explicit TrajectoryConstraints_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit TrajectoryConstraints_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
...
#endif  // MOVEIT_MSGS__MSG__TRAJECTORY_CONSTRAINTS__STRUCT_HPP_
