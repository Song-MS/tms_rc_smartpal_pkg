...
#ifndef MOVEIT_MSGS__MSG__CONSTRAINT_EVAL_RESULT__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__CONSTRAINT_EVAL_RESULT__STRUCT_HPP_
...
struct ConstraintEvalResult_
{
  ...
  explicit ConstraintEvalResult_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit ConstraintEvalResult_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_alloc;
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // MOVEIT_MSGS__MSG__CONSTRAINT_EVAL_RESULT__STRUCT_HPP_
