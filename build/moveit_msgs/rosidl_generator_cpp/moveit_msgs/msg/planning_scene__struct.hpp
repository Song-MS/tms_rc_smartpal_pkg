...
#ifndef MOVEIT_MSGS__MSG__PLANNING_SCENE__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__PLANNING_SCENE__STRUCT_HPP_
...
struct PlanningScene_
{
  ...
  explicit PlanningScene_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : robot_state(_init),
  ...
  explicit PlanningScene_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : name(_alloc),
...
#endif  // MOVEIT_MSGS__MSG__PLANNING_SCENE__STRUCT_HPP_
