...
#ifndef MOVEIT_MSGS__MSG__ATTACHED_COLLISION_OBJECT__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__ATTACHED_COLLISION_OBJECT__STRUCT_HPP_
...
struct AttachedCollisionObject_
{
  ...
  explicit AttachedCollisionObject_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : object(_init),
  ...
  explicit AttachedCollisionObject_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : link_name(_alloc),
    object(_alloc, _init),
...
#endif  // MOVEIT_MSGS__MSG__ATTACHED_COLLISION_OBJECT__STRUCT_HPP_
