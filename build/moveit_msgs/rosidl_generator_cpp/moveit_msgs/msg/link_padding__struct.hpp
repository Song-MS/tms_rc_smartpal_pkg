...
#ifndef MOVEIT_MSGS__MSG__LINK_PADDING__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__LINK_PADDING__STRUCT_HPP_
...
struct LinkPadding_
{
  ...
  explicit LinkPadding_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit LinkPadding_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : link_name(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // MOVEIT_MSGS__MSG__LINK_PADDING__STRUCT_HPP_
