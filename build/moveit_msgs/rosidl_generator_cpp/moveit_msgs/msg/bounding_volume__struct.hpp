...
#ifndef MOVEIT_MSGS__MSG__BOUNDING_VOLUME__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__BOUNDING_VOLUME__STRUCT_HPP_
...
struct BoundingVolume_
{
  ...
  explicit BoundingVolume_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
  }

  explicit BoundingVolume_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
    (void)_init;
    (void)_alloc;
  }
...
#endif  // MOVEIT_MSGS__MSG__BOUNDING_VOLUME__STRUCT_HPP_
