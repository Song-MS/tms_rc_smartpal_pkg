...
#ifndef MOVEIT_MSGS__MSG__JOINT_CONSTRAINT__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__JOINT_CONSTRAINT__STRUCT_HPP_
...
struct JointConstraint_
{
  ...
  explicit JointConstraint_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  {
  ...
  explicit JointConstraint_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : joint_name(_alloc)
  {
    if (rosidl_generator_cpp::MessageInitialization::ALL == _init ||
      rosidl_generator_cpp::MessageInitialization::ZERO == _init)
...
#endif  // MOVEIT_MSGS__MSG__JOINT_CONSTRAINT__STRUCT_HPP_
