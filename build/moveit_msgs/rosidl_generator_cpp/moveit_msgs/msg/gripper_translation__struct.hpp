...
#ifndef MOVEIT_MSGS__MSG__GRIPPER_TRANSLATION__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__GRIPPER_TRANSLATION__STRUCT_HPP_
...
struct GripperTranslation_
{
  ...
  explicit GripperTranslation_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : direction(_init)
  {
  ...
  explicit GripperTranslation_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
...
#endif  // MOVEIT_MSGS__MSG__GRIPPER_TRANSLATION__STRUCT_HPP_
