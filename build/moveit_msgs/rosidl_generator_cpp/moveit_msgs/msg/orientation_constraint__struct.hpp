...
#ifndef MOVEIT_MSGS__MSG__ORIENTATION_CONSTRAINT__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__ORIENTATION_CONSTRAINT__STRUCT_HPP_
...
struct OrientationConstraint_
{
  ...
  explicit OrientationConstraint_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    orientation(_init)
  {
  ...
  explicit OrientationConstraint_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
...
#endif  // MOVEIT_MSGS__MSG__ORIENTATION_CONSTRAINT__STRUCT_HPP_
