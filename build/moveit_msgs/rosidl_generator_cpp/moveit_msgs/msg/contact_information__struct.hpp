...
#ifndef MOVEIT_MSGS__MSG__CONTACT_INFORMATION__STRUCT_HPP_
#define MOVEIT_MSGS__MSG__CONTACT_INFORMATION__STRUCT_HPP_
...
struct ContactInformation_
{
  ...
  explicit ContactInformation_(rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_init),
    position(_init),
    normal(_init)
  {
  ...
  explicit ContactInformation_(const ContainerAllocator & _alloc, rosidl_generator_cpp::MessageInitialization _init = rosidl_generator_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
...
#endif  // MOVEIT_MSGS__MSG__CONTACT_INFORMATION__STRUCT_HPP_
