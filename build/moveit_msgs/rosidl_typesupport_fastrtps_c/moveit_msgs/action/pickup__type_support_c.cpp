...
#include "moveit_msgs/action/pickup__rosidl_typesupport_fastrtps_c.h"
...
#include "moveit_msgs/msg/constraints__functions.h"  // path_constraints
#include "moveit_msgs/msg/grasp__functions.h"  // possible_grasps
#include "moveit_msgs/msg/planning_options__functions.h"  // planning_options
#include "rosidl_generator_c/string.h"  // allowed_touch_objects, attached_object_touch_links, end_effector, group_name, planner_id, support_surface_name, target_name
#include "rosidl_generator_c/string_functions.h"  // allowed_touch_objects, attached_object_touch_links, end_effector, group_name, planner_id, support_surface_name, target_name
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->target_name;
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->group_name;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->end_effector;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->support_surface_name;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->planner_id;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: target_name
  {
    ...
    if (!ros_message->target_name.data) {
      rosidl_generator_c__String__init(&ros_message->target_name);
    }
  ...
  // Field name: group_name
  {
    ...
    if (!ros_message->group_name.data) {
      rosidl_generator_c__String__init(&ros_message->group_name);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: end_effector
  {
    ...
    if (!ros_message->end_effector.data) {
      rosidl_generator_c__String__init(&ros_message->end_effector);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: possible_grasps
  {
    ...
    if (!moveit_msgs__msg__Grasp__Sequence__init(&ros_message->possible_grasps, size)) {
      return "failed to create array for field 'possible_grasps'";
    }
    auto array_ptr = ros_message->possible_grasps.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  // Field name: support_surface_name
  {
    ...
    if (!ros_message->support_surface_name.data) {
      rosidl_generator_c__String__init(&ros_message->support_surface_name);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: attached_object_touch_links
  {
    ...
    if (ros_message->attached_object_touch_links.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->attached_object_touch_links);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->attached_object_touch_links, size)) {
      return "failed to create array for field 'attached_object_touch_links'";
    }
    auto array_ptr = ros_message->attached_object_touch_links.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
  ...
  // Field name: planner_id
  {
    ...
    if (!ros_message->planner_id.data) {
      rosidl_generator_c__String__init(&ros_message->planner_id);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: allowed_touch_objects
  {
    ...
    if (ros_message->allowed_touch_objects.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->allowed_touch_objects);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->allowed_touch_objects, size)) {
      return "failed to create array for field 'allowed_touch_objects'";
    }
    auto array_ptr = ros_message->allowed_touch_objects.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
...
// already included above
// #include "moveit_msgs/msg/grasp__functions.h"  // grasp
#include "moveit_msgs/msg/move_it_error_codes__functions.h"  // error_code
#include "moveit_msgs/msg/robot_state__functions.h"  // trajectory_start
#include "moveit_msgs/msg/robot_trajectory__functions.h"  // trajectory_stages
// already included above
// #include "rosidl_generator_c/string.h"  // trajectory_descriptions
// already included above
// #include "rosidl_generator_c/string_functions.h"  // trajectory_descriptions
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: trajectory_stages
  {
    ...
    if (!moveit_msgs__msg__RobotTrajectory__Sequence__init(&ros_message->trajectory_stages, size)) {
      return "failed to create array for field 'trajectory_stages'";
    }
    auto array_ptr = ros_message->trajectory_stages.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
  ...
  // Field name: trajectory_descriptions
  {
    ...
    if (ros_message->trajectory_descriptions.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->trajectory_descriptions);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->trajectory_descriptions, size)) {
      return "failed to create array for field 'trajectory_descriptions'";
    }
    auto array_ptr = ros_message->trajectory_descriptions.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
...
// already included above
// #include "moveit_msgs/action/pickup__functions.h"  // goal
...
// already included above
// #include "moveit_msgs/action/pickup__functions.h"  // result
...
// already included above
// #include "moveit_msgs/action/pickup__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/uuid__functions.h"  // goal_id
