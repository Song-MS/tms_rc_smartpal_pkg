...
#include "moveit_msgs/msg/contact_information__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/vector3__functions.h"  // normal
#include "rosidl_generator_c/string.h"  // contact_body_1, contact_body_2
#include "rosidl_generator_c/string_functions.h"  // contact_body_1, contact_body_2
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->contact_body_1;
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->contact_body_2;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: contact_body_1
  {
    ...
    if (!ros_message->contact_body_1.data) {
      rosidl_generator_c__String__init(&ros_message->contact_body_1);
    }
  ...
  // Field name: contact_body_2
  {
    ...
    if (!ros_message->contact_body_2.data) {
      rosidl_generator_c__String__init(&ros_message->contact_body_2);
    }
    bool succeeded = rosidl_generator_c__String__assign(
