...
#include "moveit_msgs/msg/attached_collision_object__rosidl_typesupport_fastrtps_c.h"
...
#include "moveit_msgs/msg/collision_object__functions.h"  // object
#include "rosidl_generator_c/string.h"  // link_name, touch_links
#include "rosidl_generator_c/string_functions.h"  // link_name, touch_links
#include "trajectory_msgs/msg/joint_trajectory__functions.h"  // detach_posture
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: touch_links
  {
    ...
    if (ros_message->touch_links.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->touch_links);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->touch_links, size)) {
      return "failed to create array for field 'touch_links'";
    }
    auto array_ptr = ros_message->touch_links.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
