...
#include "moveit_msgs/msg/motion_plan_detailed_response__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/primitives_sequence.h"  // processing_time
#include "rosidl_generator_c/primitives_sequence_functions.h"  // processing_time
#include "rosidl_generator_c/string.h"  // description, group_name
#include "rosidl_generator_c/string_functions.h"  // description, group_name
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: description
  {
    ...
    if (ros_message->description.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->description);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->description, size)) {
  ...
  // Field name: processing_time
  {
    ...
    if (ros_message->processing_time.data) {
      rosidl_generator_c__double__Sequence__fini(&ros_message->processing_time);
    }
    if (!rosidl_generator_c__double__Sequence__init(&ros_message->processing_time, size)) {
      return "failed to create array for field 'processing_time'";
    }
    auto array_ptr = ros_message->processing_time.data;
