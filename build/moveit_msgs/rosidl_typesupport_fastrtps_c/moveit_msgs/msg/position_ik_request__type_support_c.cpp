...
#include "moveit_msgs/msg/position_ik_request__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/pose_stamped__functions.h"  // pose_stamped, pose_stamped_vector
#include "moveit_msgs/msg/constraints__functions.h"  // constraints
#include "moveit_msgs/msg/robot_state__functions.h"  // robot_state
#include "rosidl_generator_c/string.h"  // group_name, ik_link_name, ik_link_names
#include "rosidl_generator_c/string_functions.h"  // group_name, ik_link_name, ik_link_names
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->ik_link_name;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: ik_link_name
  {
    ...
    if (!ros_message->ik_link_name.data) {
      rosidl_generator_c__String__init(&ros_message->ik_link_name);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: ik_link_names
  {
    ...
    if (ros_message->ik_link_names.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->ik_link_names);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->ik_link_names, size)) {
      return "failed to create array for field 'ik_link_names'";
    }
    auto array_ptr = ros_message->ik_link_names.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
  ...
  // Field name: pose_stamped_vector
  {
    ...
    if (!geometry_msgs__msg__PoseStamped__Sequence__init(&ros_message->pose_stamped_vector, size)) {
      return "failed to create array for field 'pose_stamped_vector'";
    }
    auto array_ptr = ros_message->pose_stamped_vector.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
