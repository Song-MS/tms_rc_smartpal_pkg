...
#include "moveit_msgs/msg/planning_scene__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/transform_stamped__functions.h"  // fixed_frame_transforms
#include "moveit_msgs/msg/allowed_collision_matrix__functions.h"  // allowed_collision_matrix
#include "moveit_msgs/msg/link_padding__functions.h"  // link_padding
#include "moveit_msgs/msg/link_scale__functions.h"  // link_scale
#include "moveit_msgs/msg/object_color__functions.h"  // object_colors
#include "moveit_msgs/msg/planning_scene_world__functions.h"  // world
#include "moveit_msgs/msg/robot_state__functions.h"  // robot_state
#include "rosidl_generator_c/string.h"  // name, robot_model_name
#include "rosidl_generator_c/string_functions.h"  // name, robot_model_name
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    const rosidl_generator_c__String * str = &ros_message->robot_model_name;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: robot_model_name
  {
    ...
    if (!ros_message->robot_model_name.data) {
      rosidl_generator_c__String__init(&ros_message->robot_model_name);
    }
    bool succeeded = rosidl_generator_c__String__assign(
  ...
  // Field name: fixed_frame_transforms
  {
    ...
    if (!geometry_msgs__msg__TransformStamped__Sequence__init(&ros_message->fixed_frame_transforms, size)) {
      return "failed to create array for field 'fixed_frame_transforms'";
    }
    auto array_ptr = ros_message->fixed_frame_transforms.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
  ...
  // Field name: link_padding
  {
    ...
    if (!moveit_msgs__msg__LinkPadding__Sequence__init(&ros_message->link_padding, size)) {
      return "failed to create array for field 'link_padding'";
    }
    auto array_ptr = ros_message->link_padding.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
  ...
  // Field name: link_scale
  {
    ...
    if (!moveit_msgs__msg__LinkScale__Sequence__init(&ros_message->link_scale, size)) {
      return "failed to create array for field 'link_scale'";
    }
    auto array_ptr = ros_message->link_scale.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
  ...
  // Field name: object_colors
  {
    ...
    if (!moveit_msgs__msg__ObjectColor__Sequence__init(&ros_message->object_colors, size)) {
      return "failed to create array for field 'object_colors'";
    }
    auto array_ptr = ros_message->object_colors.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
