...
#include "moveit_msgs/msg/robot_state__rosidl_typesupport_fastrtps_c.h"
...
#include "moveit_msgs/msg/attached_collision_object__functions.h"  // attached_collision_objects
#include "sensor_msgs/msg/joint_state__functions.h"  // joint_state
#include "sensor_msgs/msg/multi_dof_joint_state__functions.h"  // multi_dof_joint_state
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: attached_collision_objects
  {
    ...
    if (!moveit_msgs__msg__AttachedCollisionObject__Sequence__init(&ros_message->attached_collision_objects, size)) {
      return "failed to create array for field 'attached_collision_objects'";
    }
    auto array_ptr = ros_message->attached_collision_objects.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
