...
#include "moveit_msgs/msg/allowed_collision_matrix__rosidl_typesupport_fastrtps_c.h"
...
#include "moveit_msgs/msg/allowed_collision_entry__functions.h"  // entry_values
#include "rosidl_generator_c/primitives_sequence.h"  // default_entry_values
#include "rosidl_generator_c/primitives_sequence_functions.h"  // default_entry_values
#include "rosidl_generator_c/string.h"  // default_entry_names, entry_names
#include "rosidl_generator_c/string_functions.h"  // default_entry_names, entry_names
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: entry_names
  {
    ...
    if (ros_message->entry_names.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->entry_names);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->entry_names, size)) {
      return "failed to create array for field 'entry_names'";
    }
    auto array_ptr = ros_message->entry_names.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
  ...
  // Field name: entry_values
  {
    ...
    if (!moveit_msgs__msg__AllowedCollisionEntry__Sequence__init(&ros_message->entry_values, size)) {
      return "failed to create array for field 'entry_values'";
    }
    auto array_ptr = ros_message->entry_values.data;
    for (size_t i = 0; i < size; ++i) {
  ...
  // Field name: default_entry_names
  {
    ...
    if (ros_message->default_entry_names.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->default_entry_names);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->default_entry_names, size)) {
      return "failed to create array for field 'default_entry_names'";
    }
    auto array_ptr = ros_message->default_entry_names.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
  ...
  // Field name: default_entry_values
  {
    ...
    if (ros_message->default_entry_values.data) {
      rosidl_generator_c__boolean__Sequence__fini(&ros_message->default_entry_values);
    }
    if (!rosidl_generator_c__boolean__Sequence__init(&ros_message->default_entry_values, size)) {
      return "failed to create array for field 'default_entry_values'";
    }
    auto array_ptr = ros_message->default_entry_values.data;
    for (size_t i = 0; i < size; ++i) {
      uint8_t tmp;
