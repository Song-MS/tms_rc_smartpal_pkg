...
#include "geometry_msgs/msg/pose__functions.h"  // mesh_poses, plane_poses, primitive_poses, subframe_poses
#include "object_recognition_msgs/msg/object_type__functions.h"  // type
#include "rosidl_generator_c/string.h"  // id, subframe_names
#include "rosidl_generator_c/string_functions.h"  // id, subframe_names
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: subframe_names
  {
    ...
    if (ros_message->subframe_names.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->subframe_names);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->subframe_names, size)) {
      return "failed to create array for field 'subframe_names'";
    }
    auto array_ptr = ros_message->subframe_names.data;
    for (size_t i = 0; i < size; ++i) {
      std::string tmp;
  ...
  // Field name: subframe_poses
  {
    ...
    if (!geometry_msgs__msg__Pose__Sequence__init(&ros_message->subframe_poses, size)) {
      return "failed to create array for field 'subframe_poses'";
    }
    auto array_ptr = ros_message->subframe_poses.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
