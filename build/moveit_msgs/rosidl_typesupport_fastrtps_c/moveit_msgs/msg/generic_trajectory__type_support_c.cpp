...
#include "moveit_msgs/msg/generic_trajectory__rosidl_typesupport_fastrtps_c.h"
...
#include "moveit_msgs/msg/cartesian_trajectory__functions.h"  // cartesian_trajectory
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: joint_trajectory
  {
    ...
    if (!trajectory_msgs__msg__JointTrajectory__Sequence__init(&ros_message->joint_trajectory, size)) {
      return "failed to create array for field 'joint_trajectory'";
    }
    auto array_ptr = ros_message->joint_trajectory.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
  ...
  // Field name: cartesian_trajectory
  {
    ...
    if (!moveit_msgs__msg__CartesianTrajectory__Sequence__init(&ros_message->cartesian_trajectory, size)) {
      return "failed to create array for field 'cartesian_trajectory'";
    }
    auto array_ptr = ros_message->cartesian_trajectory.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
