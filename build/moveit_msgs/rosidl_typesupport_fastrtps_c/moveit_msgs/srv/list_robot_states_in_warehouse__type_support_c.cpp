...
#include "moveit_msgs/srv/list_robot_states_in_warehouse__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // regex, robot
#include "rosidl_generator_c/string_functions.h"  // regex, robot
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: regex
  {
    const rosidl_generator_c__String * str = &ros_message->regex;
  ...
  // Field name: robot
  {
    const rosidl_generator_c__String * str = &ros_message->robot;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: regex
  {
    ...
    if (!ros_message->regex.data) {
      rosidl_generator_c__String__init(&ros_message->regex);
    }
  ...
  // Field name: robot
  {
    ...
    if (!ros_message->robot.data) {
      rosidl_generator_c__String__init(&ros_message->robot);
    }
    bool succeeded = rosidl_generator_c__String__assign(
      &ros_message->robot,
      tmp.c_str());
...
// already included above
// #include "rosidl_generator_c/string.h"  // states
// already included above
// #include "rosidl_generator_c/string_functions.h"  // states
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: states
  {
    ...
    if (ros_message->states.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->states);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->states, size)) {
