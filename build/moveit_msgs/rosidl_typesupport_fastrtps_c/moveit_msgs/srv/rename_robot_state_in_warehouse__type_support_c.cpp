...
#include "moveit_msgs/srv/rename_robot_state_in_warehouse__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_generator_c/string.h"  // new_name, old_name, robot
#include "rosidl_generator_c/string_functions.h"  // new_name, old_name, robot
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: old_name
  {
    const rosidl_generator_c__String * str = &ros_message->old_name;
  ...
  // Field name: new_name
  {
    const rosidl_generator_c__String * str = &ros_message->new_name;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: old_name
  {
    ...
    if (!ros_message->old_name.data) {
      rosidl_generator_c__String__init(&ros_message->old_name);
    }
  ...
  // Field name: new_name
  {
    ...
    if (!ros_message->new_name.data) {
      rosidl_generator_c__String__init(&ros_message->new_name);
    }
    bool succeeded = rosidl_generator_c__String__assign(
