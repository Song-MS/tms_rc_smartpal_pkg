...
#include "moveit_msgs/srv/grasp_planning__rosidl_typesupport_fastrtps_c.h"
...
#include "moveit_msgs/msg/collision_object__functions.h"  // movable_obstacles, target
#include "moveit_msgs/msg/grasp__functions.h"  // candidate_grasps
#include "rosidl_generator_c/string.h"  // group_name, support_surfaces
#include "rosidl_generator_c/string_functions.h"  // group_name, support_surfaces
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: support_surfaces
  {
    ...
    if (ros_message->support_surfaces.data) {
      rosidl_generator_c__String__Sequence__fini(&ros_message->support_surfaces);
    }
    if (!rosidl_generator_c__String__Sequence__init(&ros_message->support_surfaces, size)) {
  ...
  // Field name: candidate_grasps
  {
    ...
    if (!moveit_msgs__msg__Grasp__Sequence__init(&ros_message->candidate_grasps, size)) {
      return "failed to create array for field 'candidate_grasps'";
    }
    auto array_ptr = ros_message->candidate_grasps.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
  ...
  // Field name: movable_obstacles
  {
    ...
    if (!moveit_msgs__msg__CollisionObject__Sequence__init(&ros_message->movable_obstacles, size)) {
      return "failed to create array for field 'movable_obstacles'";
    }
    auto array_ptr = ros_message->movable_obstacles.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
...
// already included above
// #include "moveit_msgs/msg/grasp__functions.h"  // grasps
