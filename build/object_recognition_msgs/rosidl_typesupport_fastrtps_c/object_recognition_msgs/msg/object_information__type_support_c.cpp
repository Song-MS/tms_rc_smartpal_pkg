...
#include "object_recognition_msgs/msg/object_information__rosidl_typesupport_fastrtps_c.h"
...
#include "sensor_msgs/msg/point_cloud2__functions.h"  // ground_truth_point_cloud
#include "shape_msgs/msg/mesh__functions.h"  // ground_truth_mesh
...
static size_t _ObjectInformation__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_object_recognition_msgs__msg__ObjectInformation(
    full_bounded, 0);
}
