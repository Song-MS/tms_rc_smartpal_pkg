...
#include "object_recognition_msgs/msg/table__rosidl_typesupport_fastrtps_cpp.hpp"
...
static size_t _Table__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_Table(full_bounded, 0);
}
