...
#include "object_recognition_msgs/msg/recognized_object_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  return max_serialized_size_RecognizedObjectArray(full_bounded, 0);
}
