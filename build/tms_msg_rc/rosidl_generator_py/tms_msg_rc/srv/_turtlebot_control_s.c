...
bool tms_msg_rc__srv__turtlebot_control__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tms_msg_rc.srv._turtlebot_control.TurtlebotControl_Request",
        full_classname_dest, 58) == 0);
  }
  tms_msg_rc__srv__TurtlebotControl_Request * ros_message = _ros_message;
  {  // unit
    ...
    ros_message->unit = (int8_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // cmd
  ...
  {  // arg
    ...
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'arg'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    double * dest = ros_message->arg.data;
...
{
  /* NOTE(esteve): Call constructor of TurtlebotControl_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tms_msg_rc.srv._turtlebot_control");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TurtlebotControl_Request");
  ...
  {  // arg
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "arg");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->arg.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->arg.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->arg.size * sizeof(double));
      assert(data != NULL);
...
ROSIDL_GENERATOR_C_EXPORT
bool tms_msg_rc__srv__turtlebot_control__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tms_msg_rc.srv._turtlebot_control.TurtlebotControl_Response",
        full_classname_dest, 59) == 0);
  }
  tms_msg_rc__srv__TurtlebotControl_Response * ros_message = _ros_message;
  {  // result
  ...
  {  // val
    ...
    double * dest = ros_message->val.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
...
{
  /* NOTE(esteve): Call constructor of TurtlebotControl_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tms_msg_rc.srv._turtlebot_control");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TurtlebotControl_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
  ...
  {  // val
    ...
    if (ros_message->val.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      double * src = &(ros_message->val.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->val.size * sizeof(double));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
