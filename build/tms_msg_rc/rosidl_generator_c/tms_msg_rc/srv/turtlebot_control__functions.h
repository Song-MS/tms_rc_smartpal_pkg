...
#ifndef TMS_MSG_RC__SRV__TURTLEBOT_CONTROL__FUNCTIONS_H_
#define TMS_MSG_RC__SRV__TURTLEBOT_CONTROL__FUNCTIONS_H_
...
#include "tms_msg_rc/msg/rosidl_generator_c__visibility_control.h"

#include "tms_msg_rc/srv/turtlebot_control__struct.h"

/// Initialize srv/TurtlebotControl message.
/**
...
/// Create srv/TurtlebotControl message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tms_msg_rc__srv__TurtlebotControl_Request__init().
...
/// Destroy srv/TurtlebotControl message.
/**
 * It calls
 * tms_msg_rc__srv__TurtlebotControl_Request__fini()
...
/// Initialize array of srv/TurtlebotControl messages.
/**
...
/// Finalize array of srv/TurtlebotControl messages.
/**
 * It calls
 * tms_msg_rc__srv__TurtlebotControl_Request__fini()
...
/// Create array of srv/TurtlebotControl messages.
/**
 * It allocates the memory for the array and calls
 * tms_msg_rc__srv__TurtlebotControl_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/TurtlebotControl messages.
/**
 * It calls
 * tms_msg_rc__srv__TurtlebotControl_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tms_msg_rc__srv__TurtlebotControl_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tms_msg_rc
...
/**
 * It calls
 * tms_msg_rc__srv__TurtlebotControl_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tms_msg_rc
...
/**
 * It allocates the memory for the array and calls
 * tms_msg_rc__srv__TurtlebotControl_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tms_msg_rc
...
/**
 * It calls
 * tms_msg_rc__srv__TurtlebotControl_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TMS_MSG_RC__SRV__TURTLEBOT_CONTROL__FUNCTIONS_H_
