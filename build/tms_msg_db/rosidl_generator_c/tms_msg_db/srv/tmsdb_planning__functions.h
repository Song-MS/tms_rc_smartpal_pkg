...
#ifndef TMS_MSG_DB__SRV__TMSDB_PLANNING__FUNCTIONS_H_
#define TMS_MSG_DB__SRV__TMSDB_PLANNING__FUNCTIONS_H_
...
/// Initialize srv/TmsdbPlanning message.
/**
...
/// Finalize srv/TmsdbPlanning message.
/**
...
/// Create srv/TmsdbPlanning message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tms_msg_db__srv__TmsdbPlanning_Request__init().
...
/// Destroy srv/TmsdbPlanning message.
/**
 * It calls
 * tms_msg_db__srv__TmsdbPlanning_Request__fini()
...
/// Initialize array of srv/TmsdbPlanning messages.
/**
...
/// Finalize array of srv/TmsdbPlanning messages.
/**
 * It calls
 * tms_msg_db__srv__TmsdbPlanning_Request__fini()
...
/// Create array of srv/TmsdbPlanning messages.
/**
 * It allocates the memory for the array and calls
 * tms_msg_db__srv__TmsdbPlanning_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/TmsdbPlanning messages.
/**
 * It calls
 * tms_msg_db__srv__TmsdbPlanning_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * tms_msg_db__srv__TmsdbPlanning_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tms_msg_db
...
/**
 * It calls
 * tms_msg_db__srv__TmsdbPlanning_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_tms_msg_db
...
/**
 * It allocates the memory for the array and calls
 * tms_msg_db__srv__TmsdbPlanning_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_tms_msg_db
...
/**
 * It calls
 * tms_msg_db__srv__TmsdbPlanning_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // TMS_MSG_DB__SRV__TMSDB_PLANNING__FUNCTIONS_H_
