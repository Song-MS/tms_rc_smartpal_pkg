...
bool tms_msg_db__srv__tmsdbgetpersoninfo__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tms_msg_db.srv._tmsdbgetpersoninfo.Tmsdbgetpersoninfo_Request",
        full_classname_dest, 61) == 0);
  }
  tms_msg_db__srv__Tmsdbgetpersoninfo_Request * ros_message = _ros_message;
  {  // rostime
    PyObject * field = PyObject_GetAttrString(_pymsg, "rostime");
    if (!field) {
      return false;
    }
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'rostime'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    uint64_t * dest = ros_message->rostime.data;
  ...
  {  // id
    ...
    uint32_t * dest = ros_message->id.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
  ...
  {  // state
    ...
    uint32_t * dest = ros_message->state.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
  ...
  {  // place
    ...
    PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'place'");
    if (!seq_field) {
      Py_DECREF(field);
      return false;
    }
    ...
    uint32_t * dest = ros_message->place.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
      if (!item) {
        Py_DECREF(seq_field);
...
{
  /* NOTE(esteve): Call constructor of Tmsdbgetpersoninfo_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tms_msg_db.srv._tmsdbgetpersoninfo");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Tmsdbgetpersoninfo_Request");
  ...
  {  // rostime
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "rostime");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->rostime.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint64_t * src = &(ros_message->rostime.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->rostime.size * sizeof(uint64_t));
      assert(data != NULL);
  ...
  {  // id
    ...
    if (ros_message->id.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint32_t * src = &(ros_message->id.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->id.size * sizeof(uint32_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // state
    ...
    if (ros_message->state.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint32_t * src = &(ros_message->state.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->state.size * sizeof(uint32_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
  ...
  {  // place
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "place");
    if (!field) {
      return NULL;
    }
    assert(field->ob_type != NULL);
    ...
    if (ros_message->place.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint32_t * src = &(ros_message->place.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->place.size * sizeof(uint32_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
...
ROSIDL_GENERATOR_C_EXPORT
bool tms_msg_db__srv__tmsdbgetpersoninfo__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tms_msg_db.srv._tmsdbgetpersoninfo.Tmsdbgetpersoninfo_Response",
        full_classname_dest, 62) == 0);
  }
  tms_msg_db__srv__Tmsdbgetpersoninfo_Response * ros_message = _ros_message;
  {  // rostime
    PyObject * field = PyObject_GetAttrString(_pymsg, "rostime");
    if (!field) {
      return false;
...
{
  /* NOTE(esteve): Call constructor of Tmsdbgetpersoninfo_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tms_msg_db.srv._tmsdbgetpersoninfo");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Tmsdbgetpersoninfo_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
