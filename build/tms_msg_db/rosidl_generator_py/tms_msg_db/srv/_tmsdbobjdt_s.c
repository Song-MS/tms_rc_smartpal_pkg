...
bool tms_msg_db__srv__tmsdbobjdt__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tms_msg_db.srv._tmsdbobjdt.Tmsdbobjdt_Request",
        full_classname_dest, 45) == 0);
  }
  tms_msg_db__srv__Tmsdbobjdt_Request * ros_message = _ros_message;
  {  // furniture_id
    PyObject * field = PyObject_GetAttrString(_pymsg, "furniture_id");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->furniture_id = PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
{
  /* NOTE(esteve): Call constructor of Tmsdbobjdt_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tms_msg_db.srv._tmsdbobjdt");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Tmsdbobjdt_Request");
  ...
  {  // furniture_id
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->furniture_id);
    {
      int rc = PyObject_SetAttrString(_pymessage, "furniture_id", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool tms_msg_db__srv__tmsdbobjdt__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tms_msg_db.srv._tmsdbobjdt.Tmsdbobjdt_Response",
        full_classname_dest, 46) == 0);
  }
  tms_msg_db__srv__Tmsdbobjdt_Response * ros_message = _ros_message;
  {  // furniture_x
...
{
  /* NOTE(esteve): Call constructor of Tmsdbobjdt_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tms_msg_db.srv._tmsdbobjdt");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Tmsdbobjdt_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
