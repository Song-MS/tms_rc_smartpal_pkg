...
bool tms_msg_db__msg__tmsdb_stamped__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tms_msg_db.msg._tmsdb_stamped.TmsdbStamped",
        full_classname_dest, 42) == 0);
  }
  tms_msg_db__msg__TmsdbStamped * ros_message = _ros_message;
  {  // header
...
{
  /* NOTE(esteve): Call constructor of TmsdbStamped */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tms_msg_db.msg._tmsdb_stamped");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "TmsdbStamped");
