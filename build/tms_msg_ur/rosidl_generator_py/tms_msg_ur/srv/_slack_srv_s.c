...
bool tms_msg_ur__srv__slack_srv__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tms_msg_ur.srv._slack_srv.SlackSrv_Request",
        full_classname_dest, 42) == 0);
  }
  tms_msg_ur__srv__SlackSrv_Request * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of SlackSrv_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tms_msg_ur.srv._slack_srv");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SlackSrv_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool tms_msg_ur__srv__slack_srv__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tms_msg_ur.srv._slack_srv.SlackSrv_Response",
        full_classname_dest, 43) == 0);
  }
  tms_msg_ur__srv__SlackSrv_Response * ros_message = _ros_message;
  {  // sec
...
{
  /* NOTE(esteve): Call constructor of SlackSrv_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tms_msg_ur.srv._slack_srv");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SlackSrv_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
