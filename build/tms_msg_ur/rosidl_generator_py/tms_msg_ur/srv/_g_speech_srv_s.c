...
bool tms_msg_ur__srv__g_speech_srv__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tms_msg_ur.srv._g_speech_srv.GSpeechSrv_Request",
        full_classname_dest, 47) == 0);
  }
  tms_msg_ur__srv__GSpeechSrv_Request * ros_message = _ros_message;
...
{
  /* NOTE(esteve): Call constructor of GSpeechSrv_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tms_msg_ur.srv._g_speech_srv");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GSpeechSrv_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool tms_msg_ur__srv__g_speech_srv__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tms_msg_ur.srv._g_speech_srv.GSpeechSrv_Response",
        full_classname_dest, 48) == 0);
  }
  tms_msg_ur__srv__GSpeechSrv_Response * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of GSpeechSrv_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tms_msg_ur.srv._g_speech_srv");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GSpeechSrv_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
