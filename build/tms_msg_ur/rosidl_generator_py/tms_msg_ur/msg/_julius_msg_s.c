...
bool tms_msg_ur__msg__julius_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "tms_msg_ur.msg._julius_msg.JuliusMsg",
        full_classname_dest, 36) == 0);
  }
  tms_msg_ur__msg__JuliusMsg * ros_message = _ros_message;
  {  // data
...
{
  /* NOTE(esteve): Call constructor of JuliusMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("tms_msg_ur.msg._julius_msg");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "JuliusMsg");
